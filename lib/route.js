...
FlowRouter.route('/addriesgo/:_id', {
    name: 'addriesgo',
    action() {
        BlazeLayout.render("AppLayout", {main: "Addriesgo"});
    }
...
FlowRouter.route('/editriesgo/:_id', {
    name: 'editriesgo',
    action() {
...
FlowRouter.route('/viewnoconf/:_id', {
    name: 'viewnoconf',
    action() {
...
FlowRouter.route('/editnoconf/:_id', {
    name: 'editnoconf',
    action() {
