...
privateRoutes.route('/perfilrrhh', {
    name: 'perfilrrhh',
    action() {
        BlazeLayout.render("AppLayout", {main: "Perfilrrhh"});
    }
});
...
privateRoutes.route('/envmasivo', {
    name: 'envmasivo',
    action() {
        BlazeLayout.render("AppLayout", {main: "Envmasivo"});
    }
});
...
privateRoutes.route('/formularios', {
    name: 'formularios',
    action() {
        BlazeLayout.render("AppLayout", {main: "Formularios"});
    }
});

privateRoutes.route('/genform', {
    name: 'genform',
    action() {
        BlazeLayout.render("AppLayout", {main: "Genform"});
    }
});

privateRoutes.route('/addregistro/:_id', {
    name: 'addregistro',
    action() {
        BlazeLayout.render("AppLayout", {main: "Addregistro"});
    }
});

privateRoutes.route('/viewreg/:_id', {
    name: 'viewreg',
    action() {
        BlazeLayout.render("AppLayout", {main: "Viewreg"});
    }
});
