...
Tickets = new Mongo.Collection('tickets', {idGeneration:'MONGO'});
...
Acciones = new Mongo.Collection('acciones', {idGeneration:'MONGO'});

Encuestas = new Mongo.Collection('encuestas', {idGeneration:'MONGO'});

Reclamas = new Mongo.Collection('reclamas', {idGeneration:'MONGO'});

Formularios = new Mongo.Collection('formularios', {idGeneration:'MONGO'});
...
Manuales = new Mongo.Collection('manuales');

ManualesWords = new FS.Collection('ManualesWords', {
    stores: [new FS.Store.GridFS('ManualesWords')]
});
